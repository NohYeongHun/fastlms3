...
import com.zerobase.fastlms.util.LoginUtil;
...
public class MemberController {
    ...
    @RequestMapping("/member/record-history")
    public String recordLoginHistory(HttpServletRequest request, Principal principal) {
        String userId = principal.getName();
        LocalDateTime curLogin = LocalDateTime.now();
        String userIp = LoginUtil.getUserIp(request);
        String userAgent = LoginUtil.getUserAgent(request);

        memberHistoryService.saveLoginHistory(
                MemberHistoryInput.builder()
                        .userId(userId)
                        .curLogin(curLogin)
                        .userIp(userIp)
                        .userAgent(userAgent)
